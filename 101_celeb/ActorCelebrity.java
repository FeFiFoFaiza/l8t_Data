...
public class ActorCelebrity extends Celebrity
{
  ...
  private String movie; // most famous movie they played in
  private String role; // most famous role they played in
	 ...
	 */
	// public ActorCelebrity(String answer, String famousMovie, String famousRole)
	// {
  //   movie = famousMovie;
  //   role = famousRole;
  //   String clues = "Starred in " + famousMovie + " as " + famousRole;
  //   super(answer, clues);
	// 	processClues();
	// }
