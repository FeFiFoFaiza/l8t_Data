...
public class StartPanel extends JPanel
{
  ...
  public StartPanel(CelebrityGame controller)
  {
    ...
    this.actorRadio = new JRadioButton("Actor Celebrity");
    ...
    this.actorClue = "Enter the clues for the actor celeb separated by commas";
  ...
  private void setupPanel()
  {
    ...
    //this.add(celebrityCount);
    //this.add(countLabelText);
  ...
  private void setupListeners()
  {
    ...
    actorRadio.addActionListener(select ->
      clueLabel.setText(actorClue));

    literatureRadio.addActionListener(select ->
      clueLabel.setText(actorClue));
